...
declare function onEvent(name: "mbd.structure_formed.mod_id.component_id", handler: (event: Internal.StructureFormedEvent) => void);
declare function onEvent(name: "mbd.update_formed.mod_id.component_id1", handler: (event: Internal.UpdateFormedEvent) => void);
...
declare function onEvent(name: "mbd.structure_formed.mod_id.component_id2", handler: (event: Internal.StructureFormedEvent) => void);
declare function onEvent(name: "mbd.structure_formed.mod_id.component_id1", handler: (event: Internal.StructureFormedEvent) => void);
declare function onEvent(name: "jei.remove.recipes", handler: (event: Internal.RemoveJEIRecipesEvent) => void);
declare function onEvent(name: "mbd.dynamic_pattern.mod_id.component_id1", handler: (event: Internal.DynamicPatternEvent) => void);
...
declare function onEvent(name: "mbd.dynamic_pattern.mod_id.component_id2", handler: (event: Internal.DynamicPatternEvent) => void);
...
declare function onEvent(name: "mbd.update_renderer.mod_id.component_id1", handler: (event: Internal.UpdateRendererEvent) => void);
...
declare function onEvent(name: "mbd.update_tick.mod_id.component_id1", handler: (event: Internal.UpdateTickEvent) => void);
...
declare function onEvent(name: "mbd.write_initial_data.mod_id.component_id1", handler: (event: Internal.WriteInitialDataEvent) => void);
declare function onEvent(name: "mbd.read_initial_data.mod_id.component_id1", handler: (event: Internal.ReadInitialDataEvent) => void);
...
declare function onEvent(name: "mbd.dynamic_pattern.mod_id.component_id", handler: (event: Internal.DynamicPatternEvent) => void);
